...
const navItems = [
  { to: '/coach/clients', label: 'Clients', icon: UsersIcon },
  { to: '/coach/prepare', label: 'Prepare', icon: ClipboardIcon },
  { to: '/coach/practice', label: 'My Practice', icon: HeartIcon },
  { to: '/coach/admin', label: 'Admin', icon: CogIcon },
]
